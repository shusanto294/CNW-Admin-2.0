...
add_action('admin_init', 'cnw_initialize_enable_form_features');
...
function cnw_initialize_enable_form_features() {
    ...
    $enable_form_features = isset($options['form_settings']) ? $options['form_settings'] : array();
