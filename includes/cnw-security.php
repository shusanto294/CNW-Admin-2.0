...
function cnw_initialize_security_settings() {
	...
	$security_settings_value = isset($options['security_settings']) ? $options['security_settings'] : array();

    if (is_array($security_settings_value)) {
		if (isset($security_settings_value['cnw-hidewp'])) {
			add_filter('the_generator', '__return_empty_string');
		}

		if (isset($security_settings_value['cnw-comments'])) {
		...
		if (isset($security_settings_value['cnw-userenumeration'])) {
		...
		if (isset($security_settings_value['cnw-limit-login'])) {
