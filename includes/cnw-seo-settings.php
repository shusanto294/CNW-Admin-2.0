...
add_action('admin_init', 'cnw_initialize_enable_seo_features');
...
function display_plausible_dashboard_widget_content() {
    ...
    // Ensure the settings are an array
    $plausible_url = isset($options['plausible_url']) ? $options['plausible_url'] : array();
